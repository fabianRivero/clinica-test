    ...
    <>
      <Routes>
        ...
        <Route path="/cms" element={<AdminLayout />}>
          ...
          <Route path="catalogos/secciones-ficha" element={<AdminSeccionesFichaCatalogPage />} />
          <Route path="catalogos/maquinaria" element={<AdminMaquinariaCatalogPage />} />
