  ...
  return <section className='page-stack'>
    ...
    <SectionCard eyebrow='Edicion' title={fullName || 'Admin de sucursal'} description='Solo se puede editar usuario, email, contraseña (opcional) y telefono.'>
      <form className='form-grid' onSubmit={onSave}>
        ...
        <label className='field'><span>Teléfono</span><input className='input' type='tel' inputMode='numeric' pattern='[0-9]+' value={form.telefono} onChange={(e)=>setForm(v=>({...v, telefono:e.target.value}))} /></label>
