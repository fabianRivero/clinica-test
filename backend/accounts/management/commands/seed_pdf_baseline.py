...
class Command(BaseCommand):
    ...
    def _seed_form_configuration(self, catalogs):
        sector_specs = [
            ("DEP", "Depilacion", "Secciones de ficha clinica para servicios de depilacion y manchas.", 1),
            ("MAN", "Manchas", "Secciones de ficha clinica para servicios especializados en manchas.", 2),
            ("TAT", "Tatuajes", "Secciones de ficha clinica para servicios de borrado de tatuajes.", 3),
        ]
        sectors = {}
        ...
        catalogs["sector"] = sectors

        def sync_section(proc_key, code, name, order, sector=None):
