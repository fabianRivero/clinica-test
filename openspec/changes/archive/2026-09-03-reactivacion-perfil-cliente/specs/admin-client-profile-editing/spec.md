...
The system MUST restrict `PATCH /api/admin/clientes/{id}/perfil/` to authenticated admin users scoped to the client's branch. Unauthenticated, non-admin, and cross-branch callers MUST be rejected.
